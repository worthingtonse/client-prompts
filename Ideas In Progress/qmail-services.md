...
Name | Bytes | Description
---|---|---
Email GUID | 16 | A unique number randomly generated by the client and used for all raida mail servers for the same email. This number is put on the email file and all subsequent attachment files
...
6 | Shuffle Table Shard 3 | Like above. This is the Second 8 rows. 
7 | Subject Stripe | 05 DE 23 | Raid type, Stripe Number, 'Of Number' all remaining bytes (253) can be used for the subject. 
